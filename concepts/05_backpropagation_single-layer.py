...
drelu = np.zeros_like(outputs_batch) # array filled with zeros with shape of outputs
drelu[outputs_batch > 0] = 1 # set values related to the inputs greater than 0 as 1
drelu *= dvalues_batch # chain rule
